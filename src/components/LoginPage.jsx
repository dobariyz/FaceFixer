...
import SocialLogin from "./SocialLogin"; // Importing SocialLogin component for third-party login options
import InputField from "./InputField"; // Importing reusable InputField component for user input fields
...
const LoginPage = () => {
  ...
  export default LoginPage; // Exporting the App component for use in other parts of the application
